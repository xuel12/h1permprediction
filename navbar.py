           ...
           children=[
              ...
              dbc.DropdownMenu(
                 ...
                 children=[
                    ...
                    dbc.DropdownMenuItem("About H1B Model Selection", header=True),
                    dbc.DropdownMenuItem("H1B Model", href = '/model_h1b'),
                    dbc.DropdownMenuItem("PERM Model", href = '/model_perm'),
